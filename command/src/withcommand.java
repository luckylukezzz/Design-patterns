...
//these are commands . only have 1 method to exec. have seperate clases for on off operations too
...
//receiver object in the constructor. implentt execute with that
...
//invoker object. invokes the command
class Remote {
    private Command cmd;
